...
@ComponentScan(basePackages = "AutoWiring.WithAnnotation") // This is used to replace <context:component-scan base-package="ComponentAndComponentScan"/> in the xml file of the previous example
